...
tsp::tclwrap tcl_test {char* text int i} char* mytest1
tsp::tclwrap_eval tcl_test {char* text int i} char* mytest2
#
...
proc variadic_func {cmd args} {
    puts "Variadic func got cmd: $cmd"
    puts "got args $args"
    return "variadic ok"
}

$handle tclwrap variadic_func {char* cmd "" ...} char* variadic_func
#
# first: call from tsp
...
$handle cproc ctest1 {Tcl_Interp* interp char* text int i1} char* {
    ...
    //puts (buf);
    puts(mytest1(text,i1));
    puts ("Calling tcl variadic funcs");
    variadic_func("Command with 1 arg","Arg1",NULL);
    variadic_func("Command with 2 arg","Arg1","Arg2",NULL);
    variadic_func("Command with 3 arg","Arg1","Arg2","Arg3",NULL);
    return "ctest1 ok";
}
